...
def main():
    ...
    init_lr = []
    parameters = [{'params': net.sharedNet.module.parameters(), 'lr':0}]
    init_lr.append(0)
    parameters.append({'params': net.shared_cls.module.parameters(), 'lr': args.lr})
    init_lr.append(args.lr)
    parameters.append({'params': net.domain_feaNet.module.parameters()})
    init_lr.append(args.lr/10)
    parameters.append({'params': net.domain_cls.module.parameters(), 'lr': args.lr})
    init_lr.append(args.lr)
    for domain in domains:
        parameters.append({'params': net.splitNets[domain].module.parameters()})
        init_lr.append(args.lr/10)
