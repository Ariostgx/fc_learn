...
def main():
    ...
    init_lr = []
    parameters = [{'params': net.sharedNet.parameters(), 'lr':args.lr}]
    init_lr.append(args.lr)
    parameters.append({'params': net.domain_feaNet.parameters(), 'lr':args.lr})
    init_lr.append(args.lr)
    parameters.append({'params': net.domain_cls.parameters(), 'lr': args.lr})
    init_lr.append(args.lr)
    for domain in domains:
        parameters.append({'params': net.splitNets[domain]['feaNet'].parameters(), 'lr':args.lr})
        init_lr.append(args.lr)
